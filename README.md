...
### Instalar o Psychtoolbox (via NeuroDebian ou GitHub)
...
### Rodar o script de configuração do sistema
...
**Reinicie o computador após rodar!**

---

### Instalar o pacote GLUT necessário:
...
### Rodar em ambiente X11 (não Wayland)
...
### Testar o script MATLAB básico (com debug):
